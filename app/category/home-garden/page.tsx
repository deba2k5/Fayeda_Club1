...
const homeGardenCoupons = [
  {
    id: 25,
    title: "Home Makeover Sale",
    description: "Transform your home with amazing furniture deals",
    code: "HOME40",
    expiryDays: 8,
    type: "code",
    savings: "Up to ₹5,000",
  ...
  {
    id: 26,
    title: "Kitchen Essentials Offer",
    description: "Complete your kitchen with premium cookware",
    code: "KITCHEN30",
    expiryDays: 12,
    type: "code",
    savings: "Up to ₹3,000",
  ...
  {
    id: 27,
    title: "Bedroom Comfort Collection",
    description: "Cozy bedding and mattresses for better sleep",
    code: "BEDROOM25",
    expiryDays: 15,
    type: "code",
    savings: "Up to ₹4,000",
  ...
  {
    id: 28,
    title: "Garden Paradise Deal",
    description: "Create your dream garden with plants and tools",
    code: "GARDEN20",
    expiryDays: 20,
    type: "code",
    savings: "Up to ₹1,500",
  ...
  {
    id: 29,
    title: "Storage Solutions Sale",
    description: "Organize your home with smart storage options",
    code: "STORAGE15",
    expiryDays: 18,
    type: "code",
    savings: "Up to ₹2,000",
  ...
  {
    id: 30,
    title: "Bathroom Upgrade Offer",
    description: "Premium bath accessories and towels",
    code: "BATHROOM10",
    expiryDays: 25,
    type: "code",
    savings: "Up to ₹1,000",
...
export default function HomeGardenPage() {
  ...
  const filteredCoupons = homeGardenCoupons
    .filter(
      (coupon) =>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Category Header */}
      <section className={`bg-gradient-to-r ${homeGardenData.color} text-white py-12`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-6xl mb-4">{homeGardenData.icon}</div>
            <h2 className="text-4xl font-bold mb-4">{homeGardenData.name}</h2>
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-6">{homeGardenData.description}</p>
            <div className="text-lg">
              <span className="font-semibold">{homeGardenCoupons.length}</span> deals available
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            ...
            >
              Coupons & Deals ({homeGardenCoupons.length})
            </button>
            <button
            ...
            >
              Browse Items ({homeGardenData.items.length})
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {activeTab === "coupons" ? (
            <>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-gray-900">{filteredCoupons.length} Home & Garden Deals Found</h3>
                <p className="text-gray-600">Save money on your home and garden purchases</p>
              </div>
                    ...
                    <CardContent className="pt-0">
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button className={`w-full bg-gradient-to-r ${homeGardenData.color} hover:opacity-90`}>
                        ...
                        <DialogContent className="sm:max-w-md">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleShopNow(
                                  `https://${coupon.store.toLowerCase().replace(/\s+/g, "")}.com`,
                                  coupon.store,
                                )
                              }
                            >
            ...
            <>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Browse Home & Garden Items</h3>
                <p className="text-gray-600">Discover different types of home and garden products</p>
              </div>

              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {homeGardenData.items
                  .filter(
                    (item) =>
                    ...
                    <Card key={item.id} className="hover:shadow-xl transition-all duration-300 cursor-pointer group">
                      ...
                      <CardContent className="pt-0">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <Badge variant="secondary" className={`bg-gradient-to-r ${homeGardenData.color} text-white`}>
                            Popular
                          </Badge>
                        </div>
                        <Button className={`w-full bg-gradient-to-r ${homeGardenData.color} hover:opacity-90`}>
          ...
          {((activeTab === "coupons" && filteredCoupons.length === 0) ||
            (activeTab === "items" && homeGardenData.items.length === 0)) && (
