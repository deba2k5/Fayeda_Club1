...
const electronicsCoupons = [
  ...
  {
    id: 3,
    title: "iPhone 15 Series Launch Offer",
    description: "Special launch prices on latest iPhone models",
    code: "IPHONE15",
    expiryDays: 7,
    type: "code",
  ...
  {
    id: 4,
    title: "Gaming Laptop Bonanza",
    description: "High-performance gaming laptops at best prices",
    code: "GAMING40",
    expiryDays: 10,
    type: "code",
  ...
  },
  {
    ...
    description: "Premium audio experience at discounted rates",
    code: "AUDIO30",
    expiryDays: 12,
    type: "code",
    savings: "Up to ₹5,000",
  ...
  },
  {
    ...
    description: "Fitness tracking and smart features combined",
    code: "SMARTWATCH25",
    expiryDays: 8,
    type: "code",
    savings: "Up to ₹3,000",
...
export default function ElectronicsPage() {
  ...
  const filteredCoupons = electronicsCoupons
    .filter(
      (coupon) =>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Category Header */}
      <section className={`bg-gradient-to-r ${electronicsData.color} text-white py-12`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-6xl mb-4">{electronicsData.icon}</div>
            <h2 className="text-4xl font-bold mb-4">{electronicsData.name}</h2>
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-6">{electronicsData.description}</p>
            <div className="text-lg">
              <span className="font-semibold">{electronicsCoupons.length}</span> deals available
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            ...
            >
              Coupons & Deals ({electronicsCoupons.length})
            </button>
            <button
            ...
            >
              Browse Items ({electronicsData.items.length})
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {activeTab === "coupons" ? (
            <>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-gray-900">{filteredCoupons.length} Electronics Deals Found</h3>
                <p className="text-gray-600">Save money on your electronics purchases</p>
              </div>
                    ...
                    <CardContent className="pt-0">
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button className={`w-full bg-gradient-to-r ${electronicsData.color} hover:opacity-90`}>
            ...
            <>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Browse Electronics Items</h3>
                <p className="text-gray-600">Discover different types of electronics products</p>
              </div>
                    ...
                    <Card key={item.id} className="hover:shadow-xl transition-all duration-300 cursor-pointer group">
                      ...
                      <CardContent className="pt-0">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <Badge variant="secondary" className={`bg-gradient-to-r ${electronicsData.color} text-white`}>
                            Popular
                          </Badge>
                        </div>
                        <Button className={`w-full bg-gradient-to-r ${electronicsData.color} hover:opacity-90`}>
          ...
          {((activeTab === "coupons" && filteredCoupons.length === 0) ||
            (activeTab === "items" && electronicsData.items.length === 0)) && (
